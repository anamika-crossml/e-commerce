...
import img1 from '../images/soleil_kanga_1.jpg';
import img2 from "../images/soleil_kanga_1-150x150.jpg";
import img3 from '../images/soleil_kanga_2-150x150.jpg';
  ...
  return (
    <Grid container style={{ display: 'flex', marginTop: '300px', marginLeft: '200px' }}>
      ...
      <Grid item xs={4} sx={{ marginLeft: '-600px' }} >
        ...
        <Typography variant="h5" style={{marginTop: '50px',  color: "#967969"}}>$98.00</Typography>
        <div>
